...
- 딜 빠른 등록 modal에서 회사/거래처/제품 검색 결과가 없을 때 inline 생성 UI 표시
- 회사 inline 생성: 회사명 필수
- 거래처 inline 생성: 이름 필수, 선택된 회사가 있으면 연결
...
- 2026-06-06: 딜 빠른 등록 modal에 회사/거래처/제품 inline 생성 패널 추가
- 2026-06-06: 회사 inline 생성 성공 시 `companyId/companySearch` 자동 선택 및 거래처 선택 초기화 적용
- 2026-06-06: 거래처 inline 생성 성공 시 선택된 회사가 있으면 `companyId`와 함께 생성하고 `contactId/contactSearch` 자동 선택
...
- 딜 modal을 벗어나지 않고 없는 회사/거래처/제품을 최소 정보로 생성 가능
...
- 회사/거래처/제품 상세 필드는 G14 제외 범위라 inline form에 추가하지 않았다.
