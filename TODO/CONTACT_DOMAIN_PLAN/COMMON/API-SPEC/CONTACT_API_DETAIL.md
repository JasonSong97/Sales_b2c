...
## 22. 거래처 목록 xlsx 내보내기 API

- API 이름: 거래처 목록 xlsx 내보내기 API
...
`page`는 받지 않는다. export는 현재 검색어와 필터 조건에 맞는 전체 거래처를 대상으로 한다.
...
| `ContactExportFailed` | 500 | 거래처 xlsx export 파일 생성 실패 |
