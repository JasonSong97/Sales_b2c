...
딜은 회사, 거래처, 제품을 연결해 영업 기회를 관리하는 핵심 도메인이다. 목록 화면은 가운데에 딜 목록을 보여주고, 선택한 딜의 상세 정보를 옆에서 바로 확인하는 split view를 기본으로 한다.
...
1. `TODO/DEAL_DOMAIN_PLAN/COMMON/GOAL-WORK-ORDER.md`를 읽는다.
