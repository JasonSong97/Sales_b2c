...
8. `SOFTWARE_AGENT/ARCHITECTURE/OVERVIEW.md`
9. `SOFTWARE_AGENT/ARCHITECTURE/BACKEND.md`
10. `SOFTWARE_AGENT/ARCHITECTURE/FRONTEND_USER_WEB.md`
11. `SOFTWARE_AGENT/ARCHITECTURE/ADMIN_WEB.md`
12. `SOFTWARE_AGENT/ARCHITECTURE/TESTING.md`
13. `SOFTWARE_AGENT/CONVENTION/BACKEND.md`
14. `SOFTWARE_AGENT/CONVENTION/FRONTEND_USER_WEB.md`
15. `SOFTWARE_AGENT/CONVENTION/ADMIN_WEB.md`
16. `SOFTWARE_AGENT/CONVENTION/COMMENT_AND_LOGGING.md`
17. `PM_AGENT/CONVENTION/DOCUMENTATION.md`
18. `PM_AGENT/CONVENTION/PLANNING_REVIEW_CHECKLIST.md`
