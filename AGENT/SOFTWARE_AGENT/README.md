...
6. `DB_SCHEMA/README.md`
7. `DB_SCHEMA/AUTH_USER_SCHEMA.md`
8. `CONVENTION/BACKEND.md`
9. `CONVENTION/FRONTEND_USER_WEB.md`
10. `CONVENTION/ADMIN_WEB.md`
11. `CONVENTION/COMMENT_AND_LOGGING.md`
12. `ENGINEERING_REVIEW_CHECKLIST.md`
