...
현재 Deal 도메인은 `BE/prisma/schema.prisma`와 `BE/prisma/migrations/20260612000000_add_deal_domain/migration.sql`에 반영되어 있다.
...
- 외부 FK 응답은 flat field가 아니라 `company`, `contact`, `product` 같은 객체로 제공한다.
